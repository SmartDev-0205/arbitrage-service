...
import { TPaginationInterface } from '../../type';
  ...
  return (
    <div className="pagination-container">
      ...
      <div className="display-direction">
        ...
        <div>
          <button
            className={props.currentPage > 1 ? 'disable' : 'enable'}
            onClick={previous}
          ...
          <button
            className={props.currentPage >= Math.ceil(props.totalCount / props.displayCount) ? 'enable' : 'disable'}
            onClick={next}
